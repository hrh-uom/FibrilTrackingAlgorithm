...
#...................VOLUME RENDERING ...................
#------------------------------------------------------------------------------
def volume_render(z1=0, z2=nplanes, x1=0, x2=npix, y1=0, y2=npix):
    minivol=volume[z1:z2, x1:x2, y1:y2]#subsection
    # minivol=volume
    #plotting
    ...
    for i in whichfibs:
        j+=1
        print(f"fibril {j} of {len(whichfibs)}")
    ...
    plt.savefig(dirResults+'volumerendering/3d-render');plt.show()
volume_render()
